...
$nombre_imagen = $_FILES['prioridad']['name'];
$tipo_imagen=$_FILES['prioridad']['type'];
$tamagno_imagen=$_FILES['prioridad']['size'];
$temporall = $_FILES['prioridad']['tmp_name'];
//echo $tipo_imagen;
...
$query = "INSERT INTO autoPrioridad(prioridad) VALUES ('$nombre_imagen')";
