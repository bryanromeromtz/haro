...
$nombre_imagen = $_FILES['mejor']['name'];
$tipo_imagen=$_FILES['mejor']['type'];
$tamagno_imagen=$_FILES['mejor']['size'];
$temporall = $_FILES['mejor']['tmp_name'];
//echo $tipo_imagen;
...
$query = "INSERT INTO mejorVehiculo(mejor) VALUES ('$nombre_imagen')";
