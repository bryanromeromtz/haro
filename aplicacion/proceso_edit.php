...
$id = $_GET['id'];
$query = "UPDATE dato_vehiculo SET vendedor='$vendedor',marca='$marca',tipo='$tipo',color='$color',foto='$nombre_imagen',transmision='$transmision',ano='$ano',precio='$precio',telefono='$telefono',cilindros='$cilindros',kilometraje='$kilometraje',combustible='$combustible',listaFoto1='$listaFoto1',listaFoto2='$listaFoto2',listaFoto3='$listaFoto3',listaFoto4='$listaFoto4',listaFoto5='$listaFoto5',listaFoto6='$listaFoto6',listaFoto7='$listaFoto7',listaFoto8='$listaFoto8',listaFoto9='$listaFoto9',listaFoto10='$listaFoto10',listaFoto11='$listaFoto11',listaFoto12='$listaFoto12',listaFoto13='$listaFoto13',listaFoto14='$listaFoto14',listaFoto15='$listaFoto15',titulo='$titulo',interior='$interior' 
WHERE id='$id'";
...
if($resultado){
    echo "si se modifico";
    //header('Location: http://localhost/haroframework/mostrar.php');
    ?>
        <script>
